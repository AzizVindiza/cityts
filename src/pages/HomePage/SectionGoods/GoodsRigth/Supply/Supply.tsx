        ...
        <div className={'newSentence'}>
            <div className="container newSentence__container">
                <div className="newSentence__block">
                    <h2 className="newSentence__h2">Горящие предложение </h2>
                </div>

                <div className="newSentence__content">
                    <div onClick={() => context?.setSupply(!context?.Supply)} className="newSentence__filter">
                        <h3 className="newSentence__h3">{context?.sortSupply}</h3>
